...
const HeroInfo = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full py-12 lg:py-24 relative overflow-hidden">
      {/* info holder */}
      <div className="flex justify-center items-start flex-col w-full lg:w-[50%] px-6 md:px-12 lg:px-24 py-10 lg:py-20 gap-5 z-10">
      ...
      {/* image holder */}
      <div className="w-full lg:w-[50%] flex items-center justify-center mt-12 lg:mt-0 relative px-6 md:px-12 lg:px-0">
        {/* Glow effect */}
